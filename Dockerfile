...
RUN apt-get update && apt-get install -y python3-colcon-common-extensions ros-${ROS_DISTRO}-pcl-ros ros-${ROS_DISTRO}-eigen-conversions ros-${ROS_DISTRO}-tf2-eigen git nlohmann-json3-dev libpcl-dev libyaml-cpp-dev libtbb-dev python3-pip
